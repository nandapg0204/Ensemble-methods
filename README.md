...
<p>Note : Models that are used to build a ensemble(strong classifier) are generally referred as base model or weak classifier.</p> 
...
<h3>1. Bagging : </h3><p> In this ensemble approach, multiple instances of same base model are trained on different subsets of training data. This technique tries to capture diverse patterns from training data. </p>
